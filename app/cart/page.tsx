...
export default async function CartPage() {
  ...
  // Los precios están en centavos — dividir entre 100 para mostrar en USD
                          ...
                          <div className="cart-item__meta">
                            ...
                            {it.deliveryDays != null && (
                              <span className="cart-item__muted">
                                {it.deliveryDays} days delivery
                              </span>
                            )}
                          </div>
                        </div>

                        {/* precio en centavos → dividir entre 100 */}
                        <div className="cart-item__price">
                          ${(Number(it.tierPrice) / 100).toFixed(2)}
                        </div>
            ...
            <aside className="cart__summary">
              <div className="summary">
                ...
                <div className="summary__actions">
                  <CheckoutButton fullWidth disabled={items.length === 0} />
                  <Link href="/services">
